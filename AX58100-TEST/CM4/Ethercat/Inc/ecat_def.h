...
/** 
AX58100_HW: Shall be set if the Slave code is executed on the PIC mounted on the EL9800 EtherCAT Evaluation Board.<br>
...
#ifndef AX58100_HW
#define AX58100_HW                                 1 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#ifndef _STM32_IO4
#define _STM32_IO4                                    0 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#ifndef _STM32_IO8
#define _STM32_IO8                                    1 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#ifndef PRODUCT_CODE
#define PRODUCT_CODE                              0x80000800
#endif
...
#ifndef DEVICE_NAME
#define DEVICE_NAME                               "ASIX EtherCAT Slave"
#endif
...
#define MAX_PD_INPUT_SIZE                         0x90 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define MAX_PD_OUTPUT_SIZE                        0x78 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
